...
# Hide sidebar nav until checkboxes are checked
...
st.markdown("Welcome to Big Snapshot - your sports analytics hub for Kalshi prediction markets.")

st.markdown("### ⚠️ Before You Continue:")
...
st.session_state.gate_passed = all_checked
