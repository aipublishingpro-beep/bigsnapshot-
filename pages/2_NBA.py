...
if pace_data:
    for p in pace_data:
        lbl, clr = ("🟢 SLOW", "#00ff00") if p['pace'] < 4.5 else ("🟡 AVG", "#ffff00") if p['pace'] < 4.8 else ("🟠 FAST", "#ff8800") if p['pace'] < 5.2 else ("🔴 SHOOTOUT", "#ff0000")
...
st.divider()
st.caption("⚠️ Entertainment only. Not financial advice. v15.51")
